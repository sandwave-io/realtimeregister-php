...
class RealtimeRegisterClientTest extends TestCase
{
    ...
    {
        $client = new RealtimeRegister('https://example.com/apiv2/', 'bigsecretdonttellanyone');

        $client->setClient(new AuthorizedClient('https://example.com/apiv2/', 'bigsecretdonttellanyone'));
